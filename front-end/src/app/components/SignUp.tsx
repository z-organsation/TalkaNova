...
export default function SignUp() {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    if (imageFile) {
      ...
      alert("Vérifie ton e-mail pour confirmer ton compte. Tu pourras te connecter après confirmation.");
      router.push("/login");
  };
    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-center w-full h-[42%] sm:h-[18%] mt-4 ">
          <button
            type="submit"
            className="bt_sign h-[38px] w-[40%] sm:h-[50px] sm:w-[60%] bg-none rounded-[15px] bg-[#154D71] shadow-[0_2px_4px_rgba(51,161,224,0.65)] text-white font-semibold flex items-center justify-center  hover:bg-[#33A1E0] hover:text-[#154D71] hover:cursor-pointer transition"
          >
            Sign up
          </button>
        </div>
